...
#---------------------------------------------------------
S3_BUCKET="infralabs-global-prod-storage"
MONGODB_HOST="mongodb.infralabs.cloud:27017"
...
mongo
use infralabs_prod_edx;
db.dropDatabase();
exit

mongorestore -d infralabs_prod_edx ~/backups/mongodb/mongo-dump-${BACKUP_KEY}/edxapp --host $MONGODB_HOST
